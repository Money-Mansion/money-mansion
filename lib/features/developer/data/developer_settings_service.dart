...
class DeveloperSettings {
  ...
  const DeveloperSettings({
    ...
    required this.allowForcedUpdates,
    this.lastCheckAt,
    this.lastError,
  });
  ...
  DeveloperSettings copyWith({
    ...
    return DeveloperSettings(
      ...
      allowForcedUpdates: allowForcedUpdates ?? this.allowForcedUpdates,
...
class DeveloperSettingsService {
  ...
  static const _autoDownloadKey = 'developer.auto_download';
  static const _allowForcedUpdatesKey = 'developer.allow_forced_updates';
  ...
  Future<DeveloperSettings> loadSettings() async {
    ...
    return DeveloperSettings(
      ...
      allowForcedUpdates: prefs.getBool(_allowForcedUpdatesKey) ?? false,
  ...
  Future<void> setAllowForcedUpdates(bool value) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool(_allowForcedUpdatesKey, value);
  }
  ...
  Future<void> clearAllDeveloperSettings() async {
    ...
    await prefs.remove(_autoDownloadKey);
    await prefs.remove(_allowForcedUpdatesKey);
