...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'milestoneGoalLabel': 'Milestone',
      'milestoneProgressLabel': 'Milestones: {current}/{total}',
      ...
      'withdraw': 'Withdraw',
      'withdrawMoneyFromGoal': 'Withdraw money from {goal}',
    ...
    'sk': {
      ...
      'milestoneGoalLabel': 'Milnik',
      'milestoneProgressLabel': 'Milniky: {current}/{total}',
      'goalCompleteProgressError':
      ...
      'withdraw': 'Stiahnuť',
      'withdrawMoneyFromGoal': 'Stiahnuť peniaze z cieľa {goal}',
      'withdrawAmount': 'Zadajte sumu na stihnutie',
