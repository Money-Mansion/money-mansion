...
final List<Item> carpetItems = [
  ...
  Item(
    ...
    name: 'dúhový koberec',
    nameEn: 'rainbow rug',
    type: ItemType.decoration,    subtype: ItemSubtype.carpets,    texture: 'assets/images/items/koberec_duha.png',
    cost: 70,
    hitboxId: 'koberec',
    scale: 0.11,
  ),
  ...
  Item(
    ...
    nameEn: 'antique rug',
    type: ItemType.decoration,    subtype: ItemSubtype.carpets,    texture: 'assets/images/items/koberec_babka.png',
    cost: 70,
    hitboxId: 'koberec',
    scale: 0.11,
  ),
