...
final Map<String, List<LessonSlide>> lessonSlides = {
  ...
  'preco_peniaze_existuju': [
    ...
    LessonSlide(
      ...
      iconSize: 300,
      iconContainerSize: 320,
      storyTitle: 'The Barter Problem',
      storyTitleSk: 'Problém barteru',
      storyBody: 'Without money, people had to trade goods directly. Chrumko has an apple for a snack but prefers a cereal bar. He asks a classmate to trade, but she already has an apple. Without money, he\'d have to keep searching for the right person!',
      storyBodySk: 'Bez peňazí si ľudia museli vymieňať tovar priamo. Chrumko má na desiatu jablko, ale radšej by si dal cereálnu tyčinku. Poprosí kamarátku, ale ona jablko nechce, lebo už jedno má. Keby mal peniaze, mohol by si tyčinku kúpiť hneď!',
      accentColor: Color(0xFF9C27B0),
    ),
  ],
  ...
  'co_len_chcem': [
    ...
    LessonSlide(
      ...
      facts: [
        FactItem(emoji: '🎮', text: 'A new video game', textSk: 'Nová videohra'),
